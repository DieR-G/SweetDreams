...
const Product = () => {
    return (
        <div className='flex justify-between items-center border-2 border-purple-900 rounded mt-5 mx-4 h-12'>
            ...
            <div className='flex justify-between w-3/12 h-full text-white text-2xl'>
                <div onClick={ ()=> {} }
                ...
                <div onClick={ ()=> {} }
                    className='flex justify-center items-center bg-yellow-500 hover:bg-yellow-700 w-4/12 h-full cursor-pointer'>
                    <BiEditAlt />
                </div>

                <div onClick={ ()=> {} }
                    className='flex justify-center items-center bg-red-500 hover:bg-red-800 w-4/12 h-full cursor-pointer'>
                    <FiTrash2 />
                </div>
            </div>
        </div>
